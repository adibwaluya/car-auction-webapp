...
public class DbInitializer
{
    public static void InitDb(WebApplication app)
    {
        ...
        /* 
        allow framework to dispose of any of the services we've used
        inside this scope that we're creating
        */
    ...
    {
        // apply any pending migrations for the context to the db
        // will create db if it does not already exist
        ...
        // auctions will populate in memory
